...
export type SmallUsersCardProps = Pick<
  User,
  'id' | 'avatar' | 'first_name' | 'last_name' | 'computed_rating'
> & { company: Pick<Company, 'title' | 'avatar' | 'id'> | null };

export type MediumUsersCardProps = Pick<
  User,
  | 'id'
  | 'avatar'
  | 'first_name'
  ...
  | 'plan'
> & { company: Pick<Company, 'title' | 'avatar' | 'id'> | null } & {
  document: Pick<Document, 'verified'> | null;
};

export const smallUsersFields = [
  'id',
  'avatar',
  'first_name',
  'last_name',
...
export const mediumUsersFields = [
  'id',
  'avatar',
  'first_name',
  'last_name',
...
export const fullListingCardFields = [
  '*',
  'amenities.*, amenities.amenity.*',
].concat(mediumUsersFields.map((field) => `user_created.${field}`));

export const extraSmallListingsFields: DotSeparatedKeys<ExtraSmallListingCardProps>[] =
  ['id', 'title', 'budget', 'deal_type', 'price'];

export const smallListingsFields: DotSeparatedKeys<SmallListingCardProps>[] = [
  'id',
  'title',
  'budget',
  'deal_type',
...
export const mediumListingsFields: DotSeparatedKeys<MediumListingCardProps>[] =
  [
    'id',
    'title',
    'deal_type',
...
export const photoListingsFields: DotSeparatedKeys<PhotoListingProps>[] = [
  'id',
  'title',
  'budget',
  'photo_1',
...
export type FullListingDetailedProps = Listing & {
  user_created: MediumUsersCardProps;
...
export type LocationCardMetrics = {
  membersCount: number;
  listingsCount: number;
};

export const smallLocationFields = ['id', 'avatar', 'title'];
export const mediumLocationFields = [
  'id',
  'avatar',
  'title',
  'members.*',
