...
export const Purpose = (props: PurposeProps) => {
  ...
  return (
    <View
      className={cn(
        'p-4 bg-card rounded-3xl flex-col gap-4 w-40 border border-solid border-border',
    ...
    >
      <View className="flex-row justify-between items-center">
        ...
        <View className="rounded-full bg-background self-start w-12 h-12 flex-row justify-center items-center">
          <Icon
            color={
              isSelected
