...
export default function OffPlans() {
    ...
    return <View className="flex-1 relative">
        <View className="absolute top-0 left-0 right-0 bottom-0">
            {/** @ts-ignore */}
            <Image src={isDarkColorScheme ? OffplansImgDark : OffplansImgLight} alt="" width={width} height={height} />
        </View>
        <Header>
        ...
        <View className="flex-grow">
            <Card className="self-start w-full rounded-none">
                <CardHeader>
                    <CardTitle className="text-success">Offplans coming soon!</CardTitle>
                </CardHeader>
