...
} from 'app/components/cards/atoms/advertisements';
import {
  MediumListingCard,
...
export type ConfirmedAdvertisementCardProps = AdvertisementCardProps & {
  [IS_AD_TYPE]: boolean;
};

export const mediumCardListingsWithAds: queryFnType<
...
export const RenderMediumListingsAds = (
  props:
    | (MediumListingCardProps & ListingCardMetrics)
    | ConfirmedAdvertisementCardProps,
) => {
