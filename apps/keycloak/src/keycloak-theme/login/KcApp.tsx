...
export default function KcApp(props: { kcContext: KcContext; }) {
    ...
    */
    ...
    return (
        <ThemeProvider defaultTheme="dark" storageKey="keycloak-ui-theme">
            <div className="w-full h-4 min-h-screen flex gap-4 justify-between items-center p-4">
                <div className="w-1/2 sm:hidden md:block"><img className="w-full object-contain" src={heroImage} alt="" /></div>
                <div className="max-w-1/2 flex flex-col">
                    <img className="w-24 object-contain mx-auto" src={logo.default} alt="" />
                    <Suspense>
                        {(() => {
