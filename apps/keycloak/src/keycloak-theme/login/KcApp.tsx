import "./KcApp.css";
import "assets/shadcn-theme.css"
...
export default function KcApp(props: { kcContext: KcContext; }) {
    ...
    */
    ...
    return (
        <div className="tw-flex tw-gap-4 tw-justify-center md:tw-justify-between tw-items-center tw-w-full tw-min-h-screen">
            <div className="tw-hidden md:tw-block tw-w-1/2 tw-h-[calc(100vh-1rem)]">
                <img src={heroImage} className="tw-w-full tw-h-full tw-object-contain" alt="" />
            </div>
            <div className="tw-min-h-screen tw-flex tw-justify-center tw-flex-col gap-8 tw-w-full md:tw-w-1/2 py-4">
                <img className="tw-w-40 tw-object-contain tw-mx-auto" src={logo.default} alt="" />
                <Suspense>
                    {(() => {
