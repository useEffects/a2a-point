...
const ChatSquareDual = (props: SvgProps) => (
  <Svg
    width={800}
    height={800}
    fill="none"
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M12 6.25a.75.75 0 0 1 .75.75v8a.75.75 0 0 1-1.5 0V7a.75.75 0 0 1 .75-.75ZM8 8.25a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0V9A.75.75 0 0 1 8 8.25ZM16 8.25a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Z"
    />
  </Svg>
)
export default ChatSquareDual
